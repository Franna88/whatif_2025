...
class MobileServicesByAreaOther extends StatefulWidget {
  const MobileServicesByAreaOther({super.key});

  @override
  State<MobileServicesByAreaOther> createState() =>
      _MobileServicesByAreaOtherState();
}

class _MobileServicesByAreaOtherState extends State<MobileServicesByAreaOther> {
