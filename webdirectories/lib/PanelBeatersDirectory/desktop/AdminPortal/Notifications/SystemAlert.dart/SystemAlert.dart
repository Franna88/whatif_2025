...
import 'SystemAlertContainer.dart';

class SystemAlert extends StatefulWidget {
  final Function(int) navigateToPage;
  const SystemAlert({super.key, required this.navigateToPage});

  @override
  State<SystemAlert> createState() => _SystemAlertState();
}
