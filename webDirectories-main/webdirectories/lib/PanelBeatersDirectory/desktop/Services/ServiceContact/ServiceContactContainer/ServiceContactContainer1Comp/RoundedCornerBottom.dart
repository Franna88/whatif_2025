...
class RoundedCornerBottom extends StatefulWidget {
  final String contactList;
  final String contactDetails;

  const RoundedCornerBottom(
      {Key? key, required this.contactList, required this.contactDetails});

  @override
  State<RoundedCornerBottom> createState() => _RoundedCornerBottomState();
}

class _RoundedCornerBottomState extends State<RoundedCornerBottom> {
  @override
