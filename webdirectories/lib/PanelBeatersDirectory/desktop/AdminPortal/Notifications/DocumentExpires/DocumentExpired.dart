...
import 'DocumentExpiredContainer.dart';

class DocumentExpired extends StatefulWidget {
  final Function(int) navigateToPage;
  const DocumentExpired({super.key, required this.navigateToPage});

  @override
  State<DocumentExpired> createState() => _DocumentExpiredState();
}
