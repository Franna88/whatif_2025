...
class WatifAddMotorcycle extends StatefulWidget {
  const WatifAddMotorcycle({Key? key}) : super(key: key);

  @override
  State<WatifAddMotorcycle> createState() => _WatifAddMotorcycleState();
}

class _WatifAddMotorcycleState extends State<WatifAddMotorcycle> {
  ...
  void initState() {
    ...
    _nameController.text = 'Midnight Rider';
    _makeController.text = 'Honda';
    _modelController.text = 'CRF1100 Africa Twin';
  ...
  void _saveMotorcycle() {
    // Logic to save motorcycle
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Dropdown fields
                            _buildDropdownField(
                                "Type of Motorcycle*", _selectedType, [
                              "Sport",
                              "Cruiser",
                              "Touring",
                              "Adventure",
                            ...
                            _buildDropdownField(
                                ...
                                (value) {
                              setState(() {
                                _selectedTransmission = value ?? "Manual";
                              });
                            }, screenSize),

                            _buildDropdownField("Fuel Type", _selectedFuelType,
                                ["Petrol", "Electric", "Hybrid"], (value) {
                              setState(() {
                                _selectedFuelType = value ?? "Petrol";
                              });
                            }, screenSize),
