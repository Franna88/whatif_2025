...
class GalaryAltContainer extends StatefulWidget {
  final String galleryImage;
  final String description;

  const GalaryAltContainer({
    super.key,
  ...
  @override
  State<GalaryAltContainer> createState() => _GalaryAltContainerState();
}

class _GalaryAltContainerState extends State<GalaryAltContainer> {
  @override
