...
class InteractiveWatifDial extends StatefulWidget {
  int menuIndex;
  ...
  @override
  State<InteractiveWatifDial> createState() => _InteractiveWatifDialState();
}

class _InteractiveWatifDialState extends State<InteractiveWatifDial>
