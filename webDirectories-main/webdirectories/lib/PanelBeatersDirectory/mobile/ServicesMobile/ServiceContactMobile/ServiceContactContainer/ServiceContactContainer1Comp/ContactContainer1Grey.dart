...
class ContactContainer1Grey extends StatefulWidget {
  final String contactList;
  final String contactDetails;

  const ContactContainer1Grey(
      {Key? key, required this.contactList, required this.contactDetails});

  @override
  State<ContactContainer1Grey> createState() => _ContactContainer1GreyState();
}

class _ContactContainer1GreyState extends State<ContactContainer1Grey> {
  @override
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            width: MyUtility(context).width * 0.731,
            height: double.infinity,
            decoration: BoxDecoration(
