...
exports.generateStaticProfile = (0, https_1.onRequest)(async (req, res) => {
  var _a, _b;
  try {
    ...
    const isCurlWithGooglebot = userAgent.includes('curl') && ((_a = req.headers['user-agent']) === null || _a === void 0 ? void 0 : _a.includes('Googlebot'));
    // For testing, always serve static content on the prerendered site or if a test parameter is present
    const isPrerenderedSite = ((_b = req.headers['x-forwarded-host']) === null || _b === void 0 ? void 0 : _b.includes('prerendered')) || false;
...
exports.renderPage = (0, https_1.onRequest)(async (req, res) => {
  try {
